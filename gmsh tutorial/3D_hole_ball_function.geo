...
l1 = newl; Curve Loop(l1) = {c5,c10,c4};    
s1 = news; Surface(s1) = {l1};
l2 = newl; Curve Loop(l2) = {c9,-c5,c1};    
s2 = news; Surface(s2) = {l2};
l3 = newl; Curve Loop(l3) = {c12,-c8,-c1}; 
s3 = news; Surface(s3) = {l3};
l4 = newl; Curve Loop(l4) = {c8,-c4,c11};  
s4 = news; Surface(s4) = {l4};
l5 = newl; Curve Loop(l5) = {-c10,c6,c3};  
s5 = news; Surface(s5) = {l5};
l6 = newl; Curve Loop(l6) = {-c11,-c3,c7};  
s6 = news; Surface(s6) = {l6};
l7 = newl; Curve Loop(l7) = {-c2,-c7,-c12};
s7 = news; Surface(s7) = {l7};
l8 = newl; Curve Loop(l8) = {-c6,-c9,c2};  
