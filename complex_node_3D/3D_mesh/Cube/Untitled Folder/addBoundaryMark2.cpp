...
int main(int argc, char* argv[])
{
  ...
  for(int i = 0;i < n_tri;++ i){
    ...
    if(fabs(p0[1] - 1.0) < 1.0e-03  && fabs(p1[1] - 1.0) < 1.0e-03 && fabs(p2[1] - 1.0) < 1.0e-03 ){
      tri_geo.boundaryMark() = 2;
      boundary2++;
    }
    if(fabs(p0[0] + 1.0) < 1.0e-03  && fabs(p1[0] + 1.0) < 1.0e-03 && fabs(p2[0] + 1.0) < 1.0e-03 ){
      tri_geo.boundaryMark() = 1;
      boundary1++;
    }
    else if(fabs(p0[0] - 1.0) < 1.0e-03  && fabs(p1[0] - 1.0) < 1.0e-03 && fabs(p2[0] - 1.0) < 1.0e-03 ){
      tri_geo.boundaryMark() = 1;
      boundary1++;
    }
    else if(fabs(p0[1] + 1.0) < 1.0e-03  && fabs(p1[1] + 1.0) < 1.0e-03 && fabs(p2[1] + 1.0) < 1.0e-03 ){
      tri_geo.boundaryMark() = 1;
      boundary1++;
    }
    else if(fabs(p0[2] + 1.0) < 1.0e-03  && fabs(p1[2] + 1.0) < 1.0e-03 && fabs(p2[2] + 1.0) < 1.0e-03 ){
      tri_geo.boundaryMark() = 1;
      boundary1++;
    }
    else if(fabs(p0[2] - 1.0) < 1.0e-03  && fabs(p1[2] - 1.0) < 1.0e-03 && fabs(p2[2] - 1.0) < 1.0e-03 ){
